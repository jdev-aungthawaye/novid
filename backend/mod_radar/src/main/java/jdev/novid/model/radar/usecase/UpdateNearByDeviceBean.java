...
@Service
public class UpdateNearByDeviceBean implements UpdateNearByDevice {
    ...
    public Output execute(Input input) {
        ...
        this.radarService.addDevice(user, input.self, input.nearBy, input.deviceName, input.lat, input.lng,
                input.collectedAt);
