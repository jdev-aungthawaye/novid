 ...
 */
public class XCluster<T extends XClusterItem> {
    ...
    XCluster(double latitude, double longitude, @NonNull List<T> items,
    ...
    public boolean equals(Object o) {
        ...
        XCluster XCluster = (XCluster) o;
        return Double.compare(XCluster.latitude, latitude) == 0 &&
                Double.compare(XCluster.longitude, longitude) == 0;
    }
